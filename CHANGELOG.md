...
## [3.5.0](https://github.com/cangelid/opensourceleg/compare/opensourceleg-v3.4.1...opensourceleg-v3.5.0) (2025-09-25)


### Features

* [Moteus Interface] Pi3Hat Update and Stop Feature to be Improved [#258](https://github.com/cangelid/opensourceleg/issues/258) ([c3f32a9](https://github.com/cangelid/opensourceleg/commit/c3f32a9df3f4e66c23b7e436edc87d53ed38e16d))
* ability to untrack multiple vars as a list. ([5294194](https://github.com/cangelid/opensourceleg/commit/52941948dcdbcd3218a3346354693bf6bc523ef2))
* add callback funcionality within homing. ([87dd0f4](https://github.com/cangelid/opensourceleg/commit/87dd0f4b1cfa5c251f3bf7cfda469d4d62fa785a))
* add context manager option to profiler. Updates required docs and tests ([a193f21](https://github.com/cangelid/opensourceleg/commit/a193f21b93a9e5f719d57daffd0e36b0a987820d))
* add doc for basic motion example ([0c4da4c](https://github.com/cangelid/opensourceleg/commit/0c4da4c25982b5fecb4966bd36b524156a83fcd0))
* add docs and tutorial on softstart ([3a8057c](https://github.com/cangelid/opensourceleg/commit/3a8057c6fd1c926186ad25951806ef83d3990403))
* add docs for compiled controller ([576701c](https://github.com/cangelid/opensourceleg/commit/576701cf176e54b7633959750f0cd8b0161d56cf))
* add docs for compiled FSM controllers ([1d47f63](https://github.com/cangelid/opensourceleg/commit/1d47f630e7f61974f402b947cf847080cc9ad70c))
* add docs for fsm example walking controller python implementation ([1f48651](https://github.com/cangelid/opensourceleg/commit/1f4865192870cbd101a1be7849e4759333360299))
* add examples, tutorials, getting started docs ([27c53ba](https://github.com/cangelid/opensourceleg/commit/27c53ba60b68648197cc5b42c2218073f97291f1))
* add exception for broken load cell wire detected ([21fbd7d](https://github.com/cangelid/opensourceleg/commit/21fbd7df45143ea9cf2e5941113117ca8cdcca5d))
* Add generators module ([05e29d4](https://github.com/cangelid/opensourceleg/commit/05e29d4882f5f6e49d63a504eed44e367cf03300))
* add iterators and with context ([0fd091c](https://github.com/cangelid/opensourceleg/commit/0fd091c69931edae5e49ada5695d183646cde178))
* add methods to scale state machine ([0e9fcaf](https://github.com/cangelid/opensourceleg/commit/0e9fcaf8aa2426730a4212c9f32ba9365d003838))
* add more logger docs ([a99c33b](https://github.com/cangelid/opensourceleg/commit/a99c33b34d9d55aaec6b86c7b813683e46384ec5))
* add new banner ([8803f4d](https://github.com/cangelid/opensourceleg/commit/8803f4db5f90b071a24f7bb42f9296073e3856e8))
* add offline tutorial for osl ([e397081](https://github.com/cangelid/opensourceleg/commit/e3970817b5d0d4a0e601ca482b58ba985d6aefad))
* add repography plots to README ([7f602ae](https://github.com/cangelid/opensourceleg/commit/7f602ae8c59288b098a29a556a149759bc50fa74))
* add sensor tutorial files ([186a1e7](https://github.com/cangelid/opensourceleg/commit/186a1e7337cdb4bc3bc85961e68e3aa91c221822))
* add signal generator framework ([44a1035](https://github.com/cangelid/opensourceleg/commit/44a1035108ea09e6d526d4fcf41d054125f319f1))
* add softstart tutorial ([9c40cfd](https://github.com/cangelid/opensourceleg/commit/9c40cfde3ef912d0162bc8ab430e9cff670446f0))
* add tests and tutorials for generators module; modify data replay generator to support interpolation; allow kwargs within update calls; modify behavior of expression evaluator class to accept eval time variables ([3eb287f](https://github.com/cangelid/opensourceleg/commit/3eb287f262b556d2ae6f2967c2291c036a007fdc))
* add thread safety to logger ([551a84e](https://github.com/cangelid/opensourceleg/commit/551a84e128f117d6ba537a3921292d1dd794c100))
* add time tutorials ([51b2c57](https://github.com/cangelid/opensourceleg/commit/51b2c57ae379a854632de54017075d409b09ce0d))
* added ability to pass multiple variables to the logger track_variable method ([867d4f8](https://github.com/cangelid/opensourceleg/commit/867d4f89f1f847fb72fdf1ac94e7e04a8d108f4a))
* added docs for profiler ([34c7015](https://github.com/cangelid/opensourceleg/commit/34c70158e3934b5f25f0afa72e7536638b53164c))
* added example docstrings to profiler.py ([33a85ec](https://github.com/cangelid/opensourceleg/commit/33a85ec9cd55ddcb2e5506f5ab8021bb18e43d78))
* added heirarchical structure for documentation ([49792a6](https://github.com/cangelid/opensourceleg/commit/49792a677fc9c5ff1af936eecd5fc7cc66a005fa))
* added method for tracking attributes of object. ([21e41de](https://github.com/cangelid/opensourceleg/commit/21e41def53e48db6b4063297d9f5f3521195c851))
* added more logger unit tests ([838c96c](https://github.com/cangelid/opensourceleg/commit/838c96ca6aac1a9f23b443c53a725c5ce69d3b2b))
* added unit tests for logger methods. ([5408818](https://github.com/cangelid/opensourceleg/commit/5408818724ed45b7a217671665a61e13ec04e4a8))
* docs for state machine ([6fc6323](https://github.com/cangelid/opensourceleg/commit/6fc6323af70789ac13ed4d214d6b8f253b4af8c2))
* include encoder map calls to actuators ([9646620](https://github.com/cangelid/opensourceleg/commit/9646620a8899f3d5da994f4acc7e7d9fe62e1667))
* initial add of dephy loadcell amp via actpack ([1cd56a5](https://github.com/cangelid/opensourceleg/commit/1cd56a50cf53fe16a75a4e4dc90b26ecefd2330d))
* initial commit of fsm basic tutorial ([0bf0697](https://github.com/cangelid/opensourceleg/commit/0bf0697de7da9aff842722304f2710c19b05d0e0))
* initial commit of profiling code. ([b67e393](https://github.com/cangelid/opensourceleg/commit/b67e393c86c9436e04b184d606f0f7e119f2542c))
* minor overhaul of srtl. Now includes default non original phase ([841b314](https://github.com/cangelid/opensourceleg/commit/841b314cc16bd27aeeda26833dff6dcffacc9c93))
* more examples for actuators module ([53340e2](https://github.com/cangelid/opensourceleg/commit/53340e2a0912978d07fcd5d2c1d5607c7c7f9264))
* move offline mode methods to a common module to make it generalizeable across actuators and sensors ([f2d2437](https://github.com/cangelid/opensourceleg/commit/f2d2437e5c23881761e478b2ca1da192fbd8462c))
* move smbus from communication extra to native ([6e0505b](https://github.com/cangelid/opensourceleg/commit/6e0505b20c0f23f801ca1ca14cd9e564f05d0609))
* new fsm controller and a torque trajectory controller example ([caeb3ec](https://github.com/cangelid/opensourceleg/commit/caeb3ec142db946b41b12b9de8749dcc4dc350f3))
* offline mode, fixes [#266](https://github.com/cangelid/opensourceleg/issues/266) ([141039d](https://github.com/cangelid/opensourceleg/commit/141039dbb6470e3619c932cec569fddb3366c231))
* test fsm controller with hardware ([446685b](https://github.com/cangelid/opensourceleg/commit/446685b8c7ed7a0357fb32e07de3ea7b854eef98))
* transition to uv for development ([1860e77](https://github.com/cangelid/opensourceleg/commit/1860e77ad96359f5cd3d7df6bc24cffad01b69c5))
* updated docstrings in softrealtimeloop ([a7ef25f](https://github.com/cangelid/opensourceleg/commit/a7ef25fbccb5af4169931ed35eb6db46624fe545))
* updates to profiler unit tests. ([927715d](https://github.com/cangelid/opensourceleg/commit/927715d3a4ee141e9eeb389e1b5735d05f51ad3e))
* upgrade fsm to support general use cases ([54b65b8](https://github.com/cangelid/opensourceleg/commit/54b65b899b0b985649bf63389f39e96e83d53b17))


### Bug Fixes

* 332 update contribution steps in readme. ([7ff3d68](https://github.com/cangelid/opensourceleg/commit/7ff3d6897a7fd6f36ab3dc9a1feb40319f8a497f))
* 336 no concise way to log lots of variables ([73f65a5](https://github.com/cangelid/opensourceleg/commit/73f65a57c8e25af592db1b82ac3169af7d7246ae))
* add authorship to logger ([f2be55c](https://github.com/cangelid/opensourceleg/commit/f2be55c8563949feec84a7674e4fe585e03ee953))
* add docs on softrealtimeloop for two operating modes ([88d8e4b](https://github.com/cangelid/opensourceleg/commit/88d8e4b5c1dbe38c89dd753601ccb4dff71e7b9b))
* add gear ratio as a global var and add method to assign stream terminator ([6c38e42](https://github.com/cangelid/opensourceleg/commit/6c38e42ba86ea2e7e664b13966c29223450ec0f2))
* add i2t fault counts and thresholds to overcome pseudo ex bit triggers ([f92be1f](https://github.com/cangelid/opensourceleg/commit/f92be1f7b79ce9a8db08a18dfb9e2e80c49e470d))
* add knee trajectories to example script ([82d3870](https://github.com/cangelid/opensourceleg/commit/82d38709e11edf268bee2cab757b6fb6acd3aa9f))
* add methods to set update parameters separately ([43bf78a](https://github.com/cangelid/opensourceleg/commit/43bf78a1c41487dac78d55d4f51a1f11238ebb31))
* add more info to add_transition and update methods' docstrings about transition precedence ([1b76710](https://github.com/cangelid/opensourceleg/commit/1b767101e4cc6c26b553a6dd820c8da054843bd6))
* add tag and __init__ to sensor base, add create_joint_mappings method to osl robot class ([e4cd0da](https://github.com/cangelid/opensourceleg/commit/e4cd0da11d8461a0395b23913a809fc885fce9f4))
* added profiler to init. ([1cc76a2](https://github.com/cangelid/opensourceleg/commit/1cc76a26f216c949afe5ecfe20670682e9107d69))
* bug in profiler t0 ([4d39347](https://github.com/cangelid/opensourceleg/commit/4d39347da9b88523e99483a165575484ae074f83))
* change type union to make tox happy ([52504e8](https://github.com/cangelid/opensourceleg/commit/52504e8dfbcfdbf49d83be694304df250780cdae))
* clean up torque trajectory example ([b36168a](https://github.com/cangelid/opensourceleg/commit/b36168aa70e71db2fec46c68abd71458a55d89ad))
* docs path fix and removed old fsm tests ([dc36bd1](https://github.com/cangelid/opensourceleg/commit/dc36bd18b6590d0a6539fcea9a39d8458fd429b0))
* docs update ([ba80c8e](https://github.com/cangelid/opensourceleg/commit/ba80c8e359846a50aaae8cc634f7c2e363d3529b))
* docs update and add __del__ method to logger ([2b3e16d](https://github.com/cangelid/opensourceleg/commit/2b3e16d9fbb393cc458c5130da43a5c9c221c678))
* docstring ([e152658](https://github.com/cangelid/opensourceleg/commit/e1526581686e49238faaa4a82e98578d92b06670))
* file_name was set to empty string in set_file_name method ([ecdbd77](https://github.com/cangelid/opensourceleg/commit/ecdbd77c2b42390597ad117a7cdaf8350a590782))
* fix [#347](https://github.com/cangelid/opensourceleg/issues/347) and update fsm example to include actuator tags ([39a2dee](https://github.com/cangelid/opensourceleg/commit/39a2deeaeb1ebda30f6eefa6a39d86096f81da95))
* fix [#347](https://github.com/cangelid/opensourceleg/issues/347) and update fsm example to include actuator tags ([11d3f3c](https://github.com/cangelid/opensourceleg/commit/11d3f3c8a9370c754291bd7f75b9cb1995cc6af7))
* fixes [#354](https://github.com/cangelid/opensourceleg/issues/354) ([74d0b2f](https://github.com/cangelid/opensourceleg/commit/74d0b2f496f12cbad1486c0d1d39c8038955496f))
* handle scenario where actuator does not have a make_encoder_map func ([1d2fc08](https://github.com/cangelid/opensourceleg/commit/1d2fc08247ab9bf928818b288e075f47fb5713c9))
* inherit from encoder base ([3a07c5f](https://github.com/cangelid/opensourceleg/commit/3a07c5f419e9547855c4b57b71362a1f3749b906))
* limit number of attempts in ADC's update method to 1000 ([042afe5](https://github.com/cangelid/opensourceleg/commit/042afe5605321f5b56db7acfa972620925f7e238))
* line numbers in fsm example quotes ([adc9ea3](https://github.com/cangelid/opensourceleg/commit/adc9ea3961de6c81d7febffab6abf0db5b7daeed))
* line numbers in fsm example quotes ([7f131cd](https://github.com/cangelid/opensourceleg/commit/7f131cd18903b8ef3a8cf7d46bba433ccf805742))
* lint and format updates. ([3687884](https://github.com/cangelid/opensourceleg/commit/36878847d040b6fd96e397809d4d041ca37b833d))
* load encoder map as polynomial object instead of raw coefficients ([8976967](https://github.com/cangelid/opensourceleg/commit/8976967ba0fa84f1f4f5c202ec7e64f951f0efb6))
* load encoder map as polynomial object instead of raw coefficients ([34bb3c1](https://github.com/cangelid/opensourceleg/commit/34bb3c18499f47be0cbb9906b514428771565f49))
* make actuator deps optional in __init__ ([ddb0542](https://github.com/cangelid/opensourceleg/commit/ddb054214da7f79e0f9d087a5b87d330a81be556))
* Microstrain IMU is only compatible with specific streaming frequencies [#384](https://github.com/cangelid/opensourceleg/issues/384) ([c8575f3](https://github.com/cangelid/opensourceleg/commit/c8575f3c41289c66b557665919d972996548f873))
* Microstrain IMU is only compatible with specific streaming frequencies [#384](https://github.com/cangelid/opensourceleg/issues/384) ([01b2f44](https://github.com/cangelid/opensourceleg/commit/01b2f440806c71e9b57c2d4e33827d8af2e60d23))
* minor changes to imu source. ([093c05b](https://github.com/cangelid/opensourceleg/commit/093c05bf4670dce029cbd148e07020484ff77890))
* minor doc update ([419c985](https://github.com/cangelid/opensourceleg/commit/419c9856bec7103a1b4ed104c8232c9efcbcf561))
* modify tutorial scripts to follow a similar pattern across various control modes ([42da482](https://github.com/cangelid/opensourceleg/commit/42da482a96cf0721d37a53219b82ac0f578f0b25))
* move FOS to I2R term instead of I; add generalized _filter_sensor method ([8ae963f](https://github.com/cangelid/opensourceleg/commit/8ae963f3af1cf1466f00155ab4e35582004aef60))
* move pi3hat warning to MoteusInterface ([dae3db6](https://github.com/cangelid/opensourceleg/commit/dae3db6e340a5db5a313e740185ebc5191acefe3))
* move safety guidelines to getting started ([d9be93e](https://github.com/cangelid/opensourceleg/commit/d9be93e8d72b5d5ff23296500cd065595fdb0018))
* mypy errors on base ([87b3634](https://github.com/cangelid/opensourceleg/commit/87b3634ced57b2336a4dac1f62ab3aeeb0c53902))
* no more zero division error in time/srtl ([abda2b9](https://github.com/cangelid/opensourceleg/commit/abda2b9560a2226a8a959dabd716aca773699763))
* patches for more unit tests ([b605a28](https://github.com/cangelid/opensourceleg/commit/b605a282ba8a52ae144f2e1b12515cc9273b8900))
* prettier changed an indentation in readme ([e6fc759](https://github.com/cangelid/opensourceleg/commit/e6fc759e95feaffc2f568ab0fe3154be296ec842))
* prettier doesn't modify docs' md file ([8384d04](https://github.com/cangelid/opensourceleg/commit/8384d042e92eba098554543a1a2f488bc9c82836))
* refactor units' classes and methods in walking_compiled_controller example script ([8ff3a5f](https://github.com/cangelid/opensourceleg/commit/8ff3a5fc00fcd5fcaea8129dc05fa98801e08c98))
* remove all references to knee, ankle, and impedance parameters ([5ff0aa1](https://github.com/cangelid/opensourceleg/commit/5ff0aa1008e918a7b52f2892d5fe176125c277d5))
* remove data and use args, kwargs--wild west approach ([95c0325](https://github.com/cangelid/opensourceleg/commit/95c0325cc9746efa5df93a643ce9db80b7751043))
* remove duplicate LogLevel initialization and minor mypy errors ([4d41ba9](https://github.com/cangelid/opensourceleg/commit/4d41ba928d7edbcf699d16ef23bfb8b00528802d))
* remove excessive typecasting from loadcell ([4ba1200](https://github.com/cangelid/opensourceleg/commit/4ba120030f3ca0ecfb5a60a15d315bd5b261546e))
* remove exit state; add warning before overwriting initial state; remove add_state and add_event methods ([c1fe887](https://github.com/cangelid/opensourceleg/commit/c1fe8879047c414d6caf2630bf35b3069ec3c992))
* remove joint attributes from actuators (BREAKING CHANGE), remove redundant logic from homing routine ([20bdb9c](https://github.com/cangelid/opensourceleg/commit/20bdb9c8e21ce2c0d5ad444d87ec3f6e88d8e816))
* remove old tests ([d3ac43d](https://github.com/cangelid/opensourceleg/commit/d3ac43db4ba4b828d4f793267513117dc9e12f85))
* remove redundant methods and complexity within signal generator ABC ([ae49c2d](https://github.com/cangelid/opensourceleg/commit/ae49c2dba18ca45fc90a3fd400b09e1bc4d9ca5c))
* remove statistical outlier detection, use min-max bounds only; add consecutive fault count tracking for current and case temp; throw an exception if data packets are corrupted for more than half a second ([6abf422](https://github.com/cangelid/opensourceleg/commit/6abf42289a4b57c6c5c5f1c87466a57ea97dc52a))
* remove trailing whitespaces ([4153f26](https://github.com/cangelid/opensourceleg/commit/4153f26a5163d454eabd03b1a003f71b19b23560))
* remove unused commented lines ([f4450df](https://github.com/cangelid/opensourceleg/commit/f4450df0176fc78354b3e6fa502b1c8ad2384340))
* remove WMA filter ([8ded24a](https://github.com/cangelid/opensourceleg/commit/8ded24ada6b69078e906112ca36ef3104534d032))
* removed unit test for deprecated log method ([ac127a1](https://github.com/cangelid/opensourceleg/commit/ac127a14170ba8bfa73707b4ce95eaa6c28712d7))
* removed unnecessary type directive. Fixed in other pull requests that check for the os on these lines ([5b74fc6](https://github.com/cangelid/opensourceleg/commit/5b74fc6fe4c094a4f19495bc1a995b9b680df904))
* rename encoder map function for clarity ([71e4e8b](https://github.com/cangelid/opensourceleg/commit/71e4e8b80e5b83849d33f272985568001c41b727))
* rename set_zero to set_zero_position and use logger instead of print ([1bbc70e](https://github.com/cangelid/opensourceleg/commit/1bbc70ed22151d7a2aebad2428f1117d40908017))
* renamed method in logger to track_function. More accurately represents what is happening. ([5a9c03c](https://github.com/cangelid/opensourceleg/commit/5a9c03c6f8c25396fed86784801537cf7a0706fc))
* replace self init with super, hardware test updates, and base class init fixes ([99fb3c3](https://github.com/cangelid/opensourceleg/commit/99fb3c3ac6aca3b456912aa4d3117c8012fe69a0))
* repr edits to actuator and encoder ([c6ae4ee](https://github.com/cangelid/opensourceleg/commit/c6ae4ee3899c6232d3b4aa229f911bdc75c4dbda))
* repr edits to actuator and encoder ([09b815e](https://github.com/cangelid/opensourceleg/commit/09b815e09fe71594dab72d11d856a2b7bce409c8))
* required control modes for methods are not set via an internal mapping instead of [@requires](https://github.com/requires) ([91d1e6b](https://github.com/cangelid/opensourceleg/commit/91d1e6b08c264b1716cf9814b791ebc606d356c2))
* reset fault count to zero for every successful data read; move status-ex fault checking to a separate method ([8c5a6fa](https://github.com/cangelid/opensourceleg/commit/8c5a6fa28b2244de90d45af2e70e01e3dc75c9d6))
* Resolve mypy type errors ([5cb1f39](https://github.com/cangelid/opensourceleg/commit/5cb1f390e050d9ce13767ba2b35e8a3d389fab5b))
* resolve ruff and mypy errors ([dd9c9d4](https://github.com/cangelid/opensourceleg/commit/dd9c9d4d327b3d4074968526ae49f1bf92f72908))
* resolved issues with __ne__ operator and _custom_data attribute ([fb971f8](https://github.com/cangelid/opensourceleg/commit/fb971f84f11a63aad4fc767f7eff3843746a5ad4))
* revert controllers to control ([7b65813](https://github.com/cangelid/opensourceleg/commit/7b65813fddcdf897ac821031bf6d552932d3a62b))
* revert directory rename ([c0216a4](https://github.com/cangelid/opensourceleg/commit/c0216a45e7088b1ba0054d6fae30f3245d7eb5ec))
* ruff ([8500c23](https://github.com/cangelid/opensourceleg/commit/8500c2346de1839902262d6fe462f88e5f0a101d))
* ruff update. ([c05f544](https://github.com/cangelid/opensourceleg/commit/c05f5447230b8484e1bfaa8df3c6bac7ad5f50bb))
* ruff whitespace ([c8025af](https://github.com/cangelid/opensourceleg/commit/c8025afe8c9f876f1b67218c5fbae8ec883332aa))
* switch to command_motor_impedance for new Dephy API instead of command_motor_position ([a72dc9b](https://github.com/cangelid/opensourceleg/commit/a72dc9bcb9c76656c84ec26601e7aa695ba22e0b))
* type annotations in loadcell ([3b53a25](https://github.com/cangelid/opensourceleg/commit/3b53a2594731fa2a4cd82b027d1c45700650b864))
* types in doc for compiled control ([50688ca](https://github.com/cangelid/opensourceleg/commit/50688cacd7ef2bb2cf2910b0e32450d13b372d56))
* unit tests are now compatible with new logger setup ([a0d80d7](https://github.com/cangelid/opensourceleg/commit/a0d80d7e4485cb5541b3b327ad078c6e6fbcf135))
* unit tests for sensor classes ([026bbb0](https://github.com/cangelid/opensourceleg/commit/026bbb0e5b31814beadaa9c16e30e7a2f8ef44f2))
* update contribution steps in readme. ([71501fe](https://github.com/cangelid/opensourceleg/commit/71501feadc30e057c300a75005e8d562ce898bba))
* update default port for imu example ([e44bd29](https://github.com/cangelid/opensourceleg/commit/e44bd290e899858821259dff95a0ab329cb0730a))
* update example line numbers ([cd8ed40](https://github.com/cangelid/opensourceleg/commit/cd8ed40f18ac03ce442f04373df7b2afda34233e))
* update homing tutorial for new callbacks ([6f8bfb1](https://github.com/cangelid/opensourceleg/commit/6f8bfb10ecd7210d11cfb1dc57ac78cee0357fbd))
* update line numbers in docs quote ([22226a3](https://github.com/cangelid/opensourceleg/commit/22226a357388b3fbda728b37df47643209a05993))
* update method signature now matches the entire library; fix [#307](https://github.com/cangelid/opensourceleg/issues/307) ([8eed688](https://github.com/cangelid/opensourceleg/commit/8eed6889480dace91ecf097bafe379cc5df02460))
* update softrealtime loop doc ([bf2f433](https://github.com/cangelid/opensourceleg/commit/bf2f43353dfef7f8065e6d2ee749982cfe8c8c02))
* update thermal model unit tests ([e87b86c](https://github.com/cangelid/opensourceleg/commit/e87b86c095a482ab23845d9cee17a5fe5c9d338a))
* update to demo loadcell func for i2c ([c8ff5f9](https://github.com/cangelid/opensourceleg/commit/c8ff5f945a30583503459c8ae99dad8ef5894f75))
* update to docstrings in logger ([3ee930f](https://github.com/cangelid/opensourceleg/commit/3ee930fa9c4de5501a7aba91375abd604d5de30a))
* update unit tests for thermal model and add a few more test ([7a98d07](https://github.com/cangelid/opensourceleg/commit/7a98d079915d44a5dba8def6e604ea50284d62d2))
* updated mkdocs ([3301f19](https://github.com/cangelid/opensourceleg/commit/3301f198bf949a494f3f6fa5fb9686ac3a4cf285))
* use if conditions instead of asserts ([c53e6a8](https://github.com/cangelid/opensourceleg/commit/c53e6a8308c61ade3a88a1a42e3ed0f10db5e7b9))
* use soft realtime clock instead of while loops ([38d216b](https://github.com/cangelid/opensourceleg/commit/38d216b32255524da920958a5df45ed6f2158925))
* wait for user input before starting to home the joint ([233a6ab](https://github.com/cangelid/opensourceleg/commit/233a6ab0725f13e17dabe48aabc187cfa8a342a8))
* whitespace ([d1d006e](https://github.com/cangelid/opensourceleg/commit/d1d006ea0086ccde82a78f5e4d68740ca7ef5025))


### Documentation

* add anujtaosf as a contributor for doc, and example ([dd60683](https://github.com/cangelid/opensourceleg/commit/dd60683bd5304129cb1ca3882c84177f2ce5cb03))
* add anushkarathi as a contributor for bug ([8dbb769](https://github.com/cangelid/opensourceleg/commit/8dbb7690ea7d0e253b0c943739c527b42f09e1da))
* add copy icon to code snippets, fix build and coverage badges ([89bec4e](https://github.com/cangelid/opensourceleg/commit/89bec4e570e7052b6aad9bb3ee3dee5c8763ce2a))
* add esharnow as a contributor for test, bug, and doc ([540b0b2](https://github.com/cangelid/opensourceleg/commit/540b0b2b4997220b316525330fd019c61a98c6f1))
* add gpranav162 as a contributor for code ([189df79](https://github.com/cangelid/opensourceleg/commit/189df7904fb9abbbf7218c61cbb4786cef129547))
* add gpranav162 as a contributor for doc ([511a88d](https://github.com/cangelid/opensourceleg/commit/511a88decb2cc9b91aa313cde66c7ccd62a07e13))
* add JapmanGill as a contributor for test, bug, and code ([cbe0248](https://github.com/cangelid/opensourceleg/commit/cbe02487191dc64301e91baf30950bb4250b79fb))
* add jderosia as a contributor for doc, test, and 2 more ([7c11478](https://github.com/cangelid/opensourceleg/commit/7c1147848d734ce5fd631b97e57eb8f4cfd0e215))
* add JerryGu-leiting as a contributor for doc ([6d79186](https://github.com/cangelid/opensourceleg/commit/6d79186e50d43a580ac66d641f9b88486ab3b1c6))
* add jkotar3 as a contributor for test, bug, and code ([c392f15](https://github.com/cangelid/opensourceleg/commit/c392f15e0b90df02bd6f7d666b6a88962e41af83))
* add Katharine-Walters as a contributor for bug ([64ab7ff](https://github.com/cangelid/opensourceleg/commit/64ab7ff58ffe9d22828a29da3b027a5b35d8c32a))
* add logger tutorial ([c05b62a](https://github.com/cangelid/opensourceleg/commit/c05b62aac5ffd6b296cc0f2b248a6b31d5549062))
* add matteo-crotti as a contributor for bug ([6b63bec](https://github.com/cangelid/opensourceleg/commit/6b63bec844e3ed7ca54ec48bb55882d9012ed0f4))
* add nundinir as a contributor for bug ([45d609f](https://github.com/cangelid/opensourceleg/commit/45d609f7a34bd2d46d9b89f5bc58f52a0a5e0b99))
* add permission denied troubleshooting note ([cf55b4c](https://github.com/cangelid/opensourceleg/commit/cf55b4c3e3def6a56973eb9ec87f21149c6f2b92))
* add Robin0265 as a contributor for test, bug, and 2 more ([22277e3](https://github.com/cangelid/opensourceleg/commit/22277e312596d6a105ffc51258b38a9ebcf71e13))
* add senthurayyappan as a contributor for infra, security, and 2 more ([62eab04](https://github.com/cangelid/opensourceleg/commit/62eab04b70d59c4eb8212b8872dde672adb12dd8))
* add shreyhas as a contributor for doc, test, and example ([10a8c38](https://github.com/cangelid/opensourceleg/commit/10a8c38a74465d941bb314a90e79ec3db9325618))
* add tkevinbest as a contributor for bug, test, and 2 more ([f499b3e](https://github.com/cangelid/opensourceleg/commit/f499b3e9843d70655e52aed33fb6a8e2c5748dd4))
* add unshrawal as a contributor for bug, and code ([aa90e31](https://github.com/cangelid/opensourceleg/commit/aa90e31aab1af2379d7765a72bc8de538e094623))
* add VarunSatyadevShetty as a contributor for doc, and example ([259f536](https://github.com/cangelid/opensourceleg/commit/259f536ffaada09ea246f19a6a1d319f6813febd))
* add zachbons as a contributor for bug ([dce517b](https://github.com/cangelid/opensourceleg/commit/dce517b53d4895e6d7738a164447f6c49569915a))
* added docstrings with examples ([381b270](https://github.com/cangelid/opensourceleg/commit/381b2706d8afd8dde16ab1040c881542d633a037))
* create .all-contributorsrc [skip ci] ([31d341b](https://github.com/cangelid/opensourceleg/commit/31d341b54658a04047ad5f2245138f2a78f38d48))
* finalize tutorials for time module ([249abcd](https://github.com/cangelid/opensourceleg/commit/249abcd4ba14652dc3081abbd2d2c38deb78dd78))
* fix encoder tutorial ([0eb49b9](https://github.com/cangelid/opensourceleg/commit/0eb49b97013862158020fc534c0d1fe6ac148e69))
* fix imu tutorial ([08b55d4](https://github.com/cangelid/opensourceleg/commit/08b55d4ee63ab2208d4c81a3d8280c916849a2ac))
* fix indentation ([383fc35](https://github.com/cangelid/opensourceleg/commit/383fc354edc52bc895aad357f38e5a4badc97f58))
* fix installation direction ([c3e5894](https://github.com/cangelid/opensourceleg/commit/c3e58945a285685d6ba6ecfd7687b06d031e8823))
* fix loadcell tutorial ([5eab5de](https://github.com/cangelid/opensourceleg/commit/5eab5de74e0d17f9e603ef3eb7ca70c674c3c88b))
* fix mkdocs errors ([1b17151](https://github.com/cangelid/opensourceleg/commit/1b171517ce8aa540611a5e55ce2b7a25d06e42b4))
* fix ruff errors ([ba36900](https://github.com/cangelid/opensourceleg/commit/ba369000371c14a19d828cb0c0a8195386592a70))
* fixed pre-commit errors ([7ff1fc9](https://github.com/cangelid/opensourceleg/commit/7ff1fc9f368884658e463b9d0549fb442b719cb0))
* fixed type: ignore error ([9d0089c](https://github.com/cangelid/opensourceleg/commit/9d0089cbd3c42c33abd0eba65cb0aa05e232e1d7))
* incomplete sensor tutorials ([e9ac0bf](https://github.com/cangelid/opensourceleg/commit/e9ac0bfce3643c0297e8ac6a158456647f2ee2c3))
* minor fix to encoder tutorial ([5d56968](https://github.com/cangelid/opensourceleg/commit/5d56968f483eca10caef716a77ceac04a1376aef))
* minor modifications to actuator base guide, add class diagram ([e490b88](https://github.com/cangelid/opensourceleg/commit/e490b887d5576178eb6b9aa53d86c533ccf13ce4))
* modified docstrings to function with mkdocs ([824d4ff](https://github.com/cangelid/opensourceleg/commit/824d4ff7b113bdbf7f548d2fcc5f9db54d364bcf))
* remove deprecated mkdocs option; address docs-test errors ([b928bf4](https://github.com/cangelid/opensourceleg/commit/b928bf44a317b6daa9afdc5691588f554b400733))
* remove examples, fix links in time tutorials, and add contributing guidelines ([c0a4a69](https://github.com/cangelid/opensourceleg/commit/c0a4a69652f712e9c46c796f5fe158c336ba34f5))
* remove old contributing section ([72cefa9](https://github.com/cangelid/opensourceleg/commit/72cefa9532a7d920f6f96c548dda4c8798ae5da2))
* removed old doc formatting ([0a88760](https://github.com/cangelid/opensourceleg/commit/0a88760de799ea07df6cc66449574d9d6830c420))
* update .all-contributorsrc [skip ci] ([682da72](https://github.com/cangelid/opensourceleg/commit/682da7259408ccd012ff1cae05768b875afacd7d))
* update .all-contributorsrc [skip ci] ([6c6c238](https://github.com/cangelid/opensourceleg/commit/6c6c23871acc2fd71ab779f17681531bf60921e3))
* update .all-contributorsrc [skip ci] ([41cf5da](https://github.com/cangelid/opensourceleg/commit/41cf5da40506316a68d9ea7e1bf812e11232620a))
* update .all-contributorsrc [skip ci] ([46f1de3](https://github.com/cangelid/opensourceleg/commit/46f1de36ed395c3ce30b19a34b2cf806a5971807))
* update .all-contributorsrc [skip ci] ([124ec2c](https://github.com/cangelid/opensourceleg/commit/124ec2c81d788cab185d3b4c00c8c1744bda9290))
* update .all-contributorsrc [skip ci] ([5962fad](https://github.com/cangelid/opensourceleg/commit/5962fad479f0344c580417878f367d48d068649d))
* update .all-contributorsrc [skip ci] ([48edfba](https://github.com/cangelid/opensourceleg/commit/48edfba384471dd0f91dde4546d036d11ad14d71))
* update .all-contributorsrc [skip ci] ([1e32e77](https://github.com/cangelid/opensourceleg/commit/1e32e7733e3e15600ba45d29e6cf1cbf1ef9e9f5))
* update .all-contributorsrc [skip ci] ([97e5151](https://github.com/cangelid/opensourceleg/commit/97e5151608a5b304675b7729846762c049b988e6))
* update .all-contributorsrc [skip ci] ([3fac0e4](https://github.com/cangelid/opensourceleg/commit/3fac0e462c3f15b3f561f3a072199e1d4cd1a15c))
* update .all-contributorsrc [skip ci] ([a29540f](https://github.com/cangelid/opensourceleg/commit/a29540fb0925c1709412d297418b324f508adce0))
* update .all-contributorsrc [skip ci] ([b917841](https://github.com/cangelid/opensourceleg/commit/b917841254c1c4ff0acadcc00f59904e6c761be6))
* update .all-contributorsrc [skip ci] ([65fbf26](https://github.com/cangelid/opensourceleg/commit/65fbf2629f1f7cbd89e6d0e2bebc7bf590ba01b4))
* update .all-contributorsrc [skip ci] ([d128ba9](https://github.com/cangelid/opensourceleg/commit/d128ba97bc8bc1e1fdc00e5d4c8419a064d8b47f))
* update .all-contributorsrc [skip ci] ([e502fa5](https://github.com/cangelid/opensourceleg/commit/e502fa50449dc11460bdee2e52af0e8909421c87))
* update .all-contributorsrc [skip ci] ([35234aa](https://github.com/cangelid/opensourceleg/commit/35234aa3399d9a7d00beb1b1947a64b03b29efc5))
* update .all-contributorsrc [skip ci] ([be90146](https://github.com/cangelid/opensourceleg/commit/be90146973fee0f9fcdeca7127fa24f908903cc5))
* update .all-contributorsrc [skip ci] ([774cee2](https://github.com/cangelid/opensourceleg/commit/774cee231ed704e670ff09a82a25dc590ff5eb91))
* update docs accordingly ([87dd0f4](https://github.com/cangelid/opensourceleg/commit/87dd0f4b1cfa5c251f3bf7cfda469d4d62fa785a))
* update README.md [skip ci] ([7e928ee](https://github.com/cangelid/opensourceleg/commit/7e928eee02d17c727e5765207acac833e1849ae1))
* update README.md [skip ci] ([09e7060](https://github.com/cangelid/opensourceleg/commit/09e7060caedfd5af9abb20d976435ade4b03c672))
* update README.md [skip ci] ([61e1336](https://github.com/cangelid/opensourceleg/commit/61e13361d1e68f418d995f1704993fdd4725c6f3))
* update README.md [skip ci] ([4558a33](https://github.com/cangelid/opensourceleg/commit/4558a3313e2d30618bac0c6f0d303e539bd0a7f0))
* update README.md [skip ci] ([a5dbc16](https://github.com/cangelid/opensourceleg/commit/a5dbc16ecce3303613609d8817c7fd6e1f879bff))
* update README.md [skip ci] ([4c754d6](https://github.com/cangelid/opensourceleg/commit/4c754d6249b3ddc9646def8715ce341f54fb9b1c))
* update README.md [skip ci] ([474c9f1](https://github.com/cangelid/opensourceleg/commit/474c9f125a62cfd9746d3bb609f7435572abf059))
* update README.md [skip ci] ([d752ccb](https://github.com/cangelid/opensourceleg/commit/d752ccbedea235ed7a6dd9469bc556d553596b56))
* update README.md [skip ci] ([82d9c43](https://github.com/cangelid/opensourceleg/commit/82d9c4302f8ac66f2abadb1c3cf7bb5c0e1bc7d2))
* update README.md [skip ci] ([8fef120](https://github.com/cangelid/opensourceleg/commit/8fef120fc45405f10d7dac06ccd16b6f7ee2b42c))
* update README.md [skip ci] ([8d7ec65](https://github.com/cangelid/opensourceleg/commit/8d7ec65c174bea9e5b07df9f4197bf2def06150d))
* update README.md [skip ci] ([ce2043e](https://github.com/cangelid/opensourceleg/commit/ce2043e90531928013df64e083bd22607c7824a8))
* update README.md [skip ci] ([419ebef](https://github.com/cangelid/opensourceleg/commit/419ebefd77673926f2992b81dfd09dd544b8f6ae))
* update README.md [skip ci] ([cffbd57](https://github.com/cangelid/opensourceleg/commit/cffbd5790df652659117d24c71300f6210529b54))
* update README.md [skip ci] ([b76d3fa](https://github.com/cangelid/opensourceleg/commit/b76d3fa6472123709197f035b66f2fc7ee62c9a4))
* update README.md [skip ci] ([63d3d5a](https://github.com/cangelid/opensourceleg/commit/63d3d5a298a2ea3678012fd5611804c1694864ef))
* update README.md [skip ci] ([0068b02](https://github.com/cangelid/opensourceleg/commit/0068b0253d9746e7831f3829a24c1ce4310426db))
* update README.md [skip ci] ([d666cf1](https://github.com/cangelid/opensourceleg/commit/d666cf1ff76b6f6b4fc7c5973192179732279e08))
* update README.md [skip ci] ([cd41541](https://github.com/cangelid/opensourceleg/commit/cd41541bec04d24c637fbe2dfc0adb1bdfab5d4f))
* updated examples and navigation structure ([52559ac](https://github.com/cangelid/opensourceleg/commit/52559ac5518562a1e8e779150a6d1481ec518bb4))
